    ...
    <div class="row">
        <div class="col-10">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <th>LessonKind name</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${lessonKinds}" var="lessonKind">
                    <tr>
                        <td><a href="${contextPath}/lesson-kind/${lessonKind.id}">${lessonKind.name}</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        </div>
        <form:form cssClass="col-2 margin-table-view" method="GET" action="${contextPath}/lesson-kind/create" class="form-signin">
