...
<div class="container">
    ...
    <form:form method="POST" action="${contextPath}/teacher-plan/create" modelAttribute="teacherPlanForm"
               class="form-signin">
        ...
        <spring:bind path="tester.id">
            <div class="form-group ${status.error ? 'has-error' : ''}"><label for="tester"> Tester: </label>
                <form:select id="tester" path="tester.id" class="selectpicker" data-show-subtext="true"
        ...
        <spring:bind path="semester.id">
            <div class="form-group ${status.error ? 'has-error' : ''}"><label for="semester"> Semester: </label>
                <form:select id="semester" path="semester.id" class="selectpicker" data-show-subtext="true"
                             data-live-search="true">
        ...
        <spring:bind path="group.id">
            <div class="form-group ${status.error ? 'has-error' : ''}"><label for="group"> Group: </label>
                <form:select id="group" path="group.id" class="selectpicker" data-show-subtext="true"
                             data-live-search="true">
        ...
        <spring:bind path="testKind.id">
            <div class="form-group ${status.error ? 'has-error' : ''}"><label for="testKind"> TestKind: </label>
                <form:select id="testKind" path="testKind.id" class="selectpicker" data-show-subtext="true"
                             data-live-search="true">
        ...
        <spring:bind path="subject.id">
            <div class="form-group ${status.error ? 'has-error' : ''}"><label for="subject"> Subject: </label>
                <form:select id="subject" path="subject.id" class="selectpicker" data-show-subtext="true"
                             data-live-search="true">
