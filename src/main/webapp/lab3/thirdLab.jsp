...
<div class="container">
    ...
    <form:form method="POST" action="${contextPath}/laplace/input" modelAttribute="init" class="form-signin">

        <spring:bind path="amountOfCondition">
            <div class="form-group">  Condition:
                <form:input type="text" path="amountOfCondition" class="form-control"
                            autofocus="true"/>
            </div>
        </spring:bind>
