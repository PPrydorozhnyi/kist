    ...
    <div class="row mt-5 justify-content-center">
        <div class="col-7">
            <div class="list-group">
                ...
                <a href="${contextPath}/alternative" class="list-group-item list-group-item-primary">Alternative</a>
                <a href="${contextPath}/gurvic" class="list-group-item list-group-item-secondary">Gurvic</a>
