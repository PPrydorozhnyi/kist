...
<div class="container">
    ...
    <form:form cssClass="f" method="POST" action="${contextPath}/violation-kind/create" modelAttribute="violationKindForm" class="form-signin">
        <h2 class="form-signin-heading">${violationKindForm.id != null ? 'Edit' : 'Create'} violation kind</h2>

        <form:hidden path="id" />

        <%--NAME--%>
        <spring:bind path="name">
            <div class="form-group ${status.error ? 'has-error' : ''}">  Violation kind name:
